        ...
        <div className="flex flex-col items-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="100" height="129" viewBox="0 0 100 129" fill="none">
            ...
            <path
              ...
              stroke-linejoin="round"
            />
            <path d="M81 89.5H26" stroke="#8F8F8F" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M73 97.5H35" stroke="#8F8F8F" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
