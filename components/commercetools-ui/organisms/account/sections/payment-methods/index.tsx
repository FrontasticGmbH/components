  ...
  return (
    <div className="px-16 md:mt-24 md:px-24 lg:mt-40 lg:px-44">
      <div className="hidden md:block">
        <h2 className="text-18 text-primary md:text-22 lg:text-24">{translate('payment.payment-methods')}</h2>
      </div>
      <div className="mt-20 lg:mt-36">
        <h2 className="text-14 text-gray-600 md:text-16">{translate('payment.payment-details')}</h2>
      </div>
      <Button
        variant="primary"
