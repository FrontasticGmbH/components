...
const List: React.FC<Props> = ({ items }) => {
  ...
  return (
    <div className="mx-auto max-w-2xl pb-16 pt-8 lg:max-w-3xl lg:pt-4">
      <h1 className="text-3xl font-extrabold text-center tracking-tight text-gray-900 sm:text-4xl pb-12">Wishlist Items</h1>
            ...
            <div className="ml-4 flex flex-1 flex-col sm:ml-6">
              <div>
                <div className="flex justify-between">
                  <h4 className="text-sm">
                    <p onClick={() => goToProductPage(item.variant.sku)} className="font-medium text-gray-700 hover:text-gray-800 cursor-pointer">
                      {' '}
                      {item.name}{' '}
                    </p>
                  </h4>
              ...
              <div className="mt-4 flex flex-1 items-end justify-between">
                <p className="flex items-center space-x-2 text-sm text-gray-700">
                  ...
                  <span>Item Added on {DateHelpers.formatDate(item.addedAt)}</span>
                </p>
                <div className="ml-4">
                  <button
                    type="button"
