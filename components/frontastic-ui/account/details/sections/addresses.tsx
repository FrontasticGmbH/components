    ...
    <>
      ...
      <div className="mt-10 divide-y divide-gray-200">
        ...
        <div className="py-4 sm:py-8">
          <button
            type="button"
            className="items-center py-2 mt-4 w-full text-sm font-medium text-center text-white bg-accent-400 disabled:bg-gray-300 rounded-md border border-transparent focus:outline-none focus:ring-2 focus:ring-accent-400 focus:ring-offset-2 shadow-sm transition-colors ease-out sm:px-24 sm:w-fit duration-150ms px:0"
