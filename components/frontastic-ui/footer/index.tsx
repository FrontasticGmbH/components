...
const Footer: React.FC<FooterProps> = ({ columns, copyright }) => {
  ...
  const renderIcon = (name: string) => {
    switch (name) {
      case 'rocket':
        return <RocketIcon className="w-6 h-6 text-gray-400" aria-hidden="true" />;
      case 'loop':
        return <LoopIcon className="w-6 h-6 text-gray-400" aria-hidden="true" />;
      case 'loop':
        return <LockIcon className="w-6 h-6 text-gray-400" aria-hidden="true" />;
      case 'question':
        return <QuestionMarkCircleIcon className="w-6 h-6 text-gray-400" aria-hidden="true" />;
      case 'inbox':
        return <InboxIcon className="w-6 h-6 text-gray-400" aria-hidden="true" />;
      case 'speaker':
        return <SpeakerphoneIcon className="w-6 h-6 text-gray-400" aria-hidden="true" />;
      default:
        return <LockIcon className="w-4 h-4 text-gray-400" aria-hidden="true" />;
    }
  };
