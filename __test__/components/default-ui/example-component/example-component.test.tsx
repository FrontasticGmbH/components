...
describe(ExampleComponent.name, () => {
    ...
    test('clicking submit button calls onSubmit function passed', () => {
        ...
        const onSubmit = jest.fn(() => { testValue = expectedTestValue; });
        const props = {
            ...defaultProps,
            onSubmit
        }
    ...
    test('email input value displays emailInputValue value passed', () => {
        ...
        expect(screen.getByRole('textbox', { name: defaultProps.emailInputLabel })).toHaveValue(defaultProps.emailInputValue);
    });
